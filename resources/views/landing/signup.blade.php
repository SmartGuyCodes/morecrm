                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        ...
                        <form action="/client-subscription" method="POST">
                            ...
                            @endif
                            <fieldset class="mb-5">
                                <label for="" class="text-xs font-semibold px-1">Subscription package</label>

                                <div class="flex items-center mb-4">
                                    <input id="package-monthly-option" type="radio" name="company_subscription_package" value="monthly" class="h-4 w-4 border-gray-300 focus:ring-2 focus:ring-blue-300" aria-labelledby="package-monthly-option" aria-describedby="package-monthly-option" checked="">
                                    <label for="package-monthly-option" class="text-sm font-medium text-gray-900 ml-2 block">
                                        Monthly
                                    </label>
                                </div>

                                <div class="flex items-center mb-4">
                                    <input id="package-quarterly-option" type="radio" name="company_subscription_package" value="quarterly" class="h-4 w-4 border-gray-300 focus:ring-2 focus:ring-blue-300" aria-labelledby="package-quarterly-option" aria-describedby="package-quarterly-option">
                                    <label for="package-quarterly-option" class="text-sm font-medium text-gray-900 ml-2 block">
                                        Quarterly
                                    </label>
                                </div>

                                <div class="flex items-center mb-4">
                                    <input id="package-yearly-option" type="radio" name="company_subscription_package" value="yearly" class="h-4 w-4 border-gray-300 focus:ring-2 focus:ring-blue-300" aria-labelledby="package-yearly-option" aria-describedby="package-yearly-option">
                                    <label for="package-yearly-option" class="text-sm font-medium text-gray-900 ml-2 block">
                                        Yearly
                                    </label>
                                </div>
                            </fieldset>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Company name<span class="text-[#ff0000]">*</span></label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                        <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" name="company_name" placeholder="" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Company email<span class="text-[#ff0000]">*</span></label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                                        <input type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="" name="company_email" required>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Company phone number<span class="text-[#ff0000]">*</span></label>
                                    <div class="flex">
                                        ...
                                        <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="+254 700 000 000" name="company_phone" required>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Company address<span class="text-[#ff0000]">*</span></label>
                                    <div class="flex">
                                        ...
                                        <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder=""  name="company_address" required>
                                        <!-- <textarea class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" name="company_address"></textarea> -->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Contact person<span class="text-[#ff0000]">*</span></label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                        <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="" name="company_contact_person_name" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Contact person phone no.<span class="text-[#ff0000]">*</span></label>
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-phone-outline text-gray-400 text-lg"></i></div>
                                        <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="+254 700 000 000" name="company_contact_person_phone" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-12">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************" name="password" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <button class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" type="submit">SUBSCRIBE NOW</button>
                                </div>
                            </div>
                        </form>
